...
{
    public class BrandMasterService:IBrandMaster
    {
        string sp_name = "USP_BrandMaster";
        public async Task<spOutputParameter> InsertBrand(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, tblBrandMaster model, int UserMaster_Code)
        {
        ...
        public async Task<spOutputParameter> DeleteBrand(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, int code, int UserMaster_Code)
        {
            using (IDbConnection conn = new MySqlConnection(_bizsolESMSConnectionDetails.DefultMysqlTemp))
            {
        ...
        public async Task<IEnumerable<dynamic>> ShowBrand(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails)
        {
        ...
        public async Task<IEnumerable<dynamic>> ShowBrandByCode(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, int code)
        {
