...
namespace Bizsol_ESMS_API.Service
{
    public class BrandMasterService:IBrandMaster
    {
        ...
        public async Task<spOutputParameter> InsertBrand(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, tblBrandMaster model)
        {
        ...
        public async Task<spOutputParameter> DeleteBrand(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, int code)
        {
            using (IDbConnection conn = new MySqlConnection(_bizsolESMSConnectionDetails.DefultMysqlTemp))
            {
