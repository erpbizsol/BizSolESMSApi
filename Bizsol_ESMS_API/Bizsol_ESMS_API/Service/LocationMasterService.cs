...
namespace Bizsol_ESMS_API.Service
{
    public class LocationMasterService: ILocationMaster
    {
        ...
        public async Task<spOutputParameter> InsertLocationMaster(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, tblLocationMaster Model)
        {
        ...
        public async Task<spOutputParameter> DeleteLocationMaster(BizsolESMSConnectionDetails _bizsolESMSConnectionDetails, int code)
        {
            using (IDbConnection conn = new MySqlConnection(_bizsolESMSConnectionDetails.DefultMysqlTemp))
            {
