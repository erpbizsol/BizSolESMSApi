...
{
    public class TATConfigurationService:ITATConfiguration
    {
        string sp_name = "USP_TATConfiguration";
        public async Task<IEnumerable<dynamic>> ShowTATConfiguration(BizsolESMSConnectionDetails bizsolESMSConnectionDetails)
        {
        ...
        public async Task<dynamic> ShowTATConfigurationByCode(BizsolESMSConnectionDetails bizsolESMSConnectionDetails, int Code)
        {
            using (IDbConnection conn = new MySqlConnection(bizsolESMSConnectionDetails.DefultMysqlTemp))
            {
                DynamicParameters parameters = new DynamicParameters();
        ...
        public async Task<dynamic> DeleteTATConfiguration(BizsolESMSConnectionDetails bizsolESMSConnectionDetails, int Code, int UserMaster_Code)
        {
            using (IDbConnection conn = new MySqlConnection(bizsolESMSConnectionDetails.DefultMysqlTemp))
            {
                DynamicParameters parameters = new DynamicParameters();
