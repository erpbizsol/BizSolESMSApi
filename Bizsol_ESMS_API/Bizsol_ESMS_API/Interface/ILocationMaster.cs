...
namespace Bizsol_ESMS_API.Interface
{
    public interface ILocationMaster
    {
        ...
        public abstract Task<spOutputParameter> InsertLocationMaster(BizsolESMSConnectionDetails _BizsolESMSConnectionDetails, tblLocationMaster model);
        public abstract Task<spOutputParameter> DeleteLocationMaster(BizsolESMSConnectionDetails _BizsolESMSConnectionDetails, int code);
    }
}
