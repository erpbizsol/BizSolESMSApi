...
namespace Bizsol_ESMS_API.Interface
{
    public interface IOrder
    {
        ...
        public abstract Task<dynamic> InsertOrderMaster(BizsolESMSConnectionDetails _BizsolESMSConnectionDetails, VM_OrderMaster model);
        public abstract Task<dynamic> DeleteOrderMaster(BizsolESMSConnectionDetails _BizsolESMSConnectionDetails, int code);
    }
}
