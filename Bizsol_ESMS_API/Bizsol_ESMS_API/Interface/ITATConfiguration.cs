...
namespace Bizsol_ESMS_API.Interface
{
    public interface ITATConfiguration
    {
        ...
        public abstract Task<dynamic> SaveTATConfiguration(BizsolESMSConnectionDetails _BizsolESMSConnectionDetails, tblTATConfiguration model, int UserMaster_Code);
